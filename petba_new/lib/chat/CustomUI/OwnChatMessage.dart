...
class OwnChatMessage extends StatefulWidget {
  ...
  @override
  _OwnChatMessageState createState() => _OwnChatMessageState();
}

class _OwnChatMessageState extends State<OwnChatMessage> {
            ...
            children: [
              Padding(
                padding: EdgeInsets.only(
                  ...
                  right: 10,
                  top: (widget.messageType == "image" ||
                      widget.messageType == "video") ? 5 : 10,
                  bottom: 20,
                ),
  ...
  Widget _buildImageWidget() {
    print('Building image widget - messageType: ${widget.messageType}, message: ${widget.message}, base64Image exists: ${widget.base64Image != null}');

    // Try base64 data first (most reliable for received images)
    if (widget.base64Image != null && widget.base64Image!.isNotEmpty) {
      try {
        return Image.memory(
    ...
    // Try local file path (for newly sent images)
    if (widget.message.isNotEmpty) {
  ...
  Widget _buildVideoWidget() {
    print('Building video widget - message: ${widget.message}, base64Image exists: ${widget.base64Image != null}');
          ...
          GestureDetector(
            onTap: () {
              if (_videoController != null && _isVideoInitialized) {
                ...
                // Show message that video cannot be played
